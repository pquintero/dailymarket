...
/**
 * Implementación dummy de httpServletRequest, para testing
 */
public class DummyHttpServletRequest implements HttpServletRequest
{
  private HttpSession httpSession;

  public DummyHttpServletRequest(User user)
  {
    this.httpSession = new DummyHttpSession(user);
  }
  ...
  /**
   * Implementacion dummy de getSession
