...
"%JAVA_HOME%\bin\jarsigner" -keystore Proyecto911 -storepass Proyecto911 swingx_v0107.jar Fahrenheit
"%JAVA_HOME%\bin\jarsigner" -keystore Proyecto911 -storepass Proyecto911 log4j-1.2.9.jar Fahrenheit
pause
