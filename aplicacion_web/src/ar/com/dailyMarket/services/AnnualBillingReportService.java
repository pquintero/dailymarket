...
public class AnnualBillingReportService extends BaseReportService{
	...
	public byte[] runReport(DynaBean reportData, Collection col, String report, Map<String, String> filters)throws Exception {
        ...
        try {
		    JasperReport jasperReport = (JasperReport) JRLoader.loadObject(AnnualBillingReportService.class.getResourceAsStream("/reports/" + report + ".jasper"));
