	...
	<tr>
		<td >
			<table width="70%" align="left" cellpadding="0"  cellspacing="0" border="0">			
				<tr align="center">
					<td><bean:message key="indicadores.comparativaDeVentasPorCajeroMensualFilter"/></td>
				</tr>
				<tr align="left">
					<td>&nbsp;</td>
				</tr>
				...
				<tr align="left">
					...
					<td>
						...
						onclick="forms[0].VirtualDispatchName.value='executeComparativaDeVentasPorCajeroMensual'; forms[0].submit();">
					</td>
				</tr>
				<tr align="left">
					<td>&nbsp;</td>
